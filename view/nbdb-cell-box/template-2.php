...
<div class="nbdb-post-image-content">
	<div class="nbdb-medium-8 nbdb-cell nbdb-left-block">
		<?php if(!empty($nbdb_post_large_image)) { ?>
			<div class="nbdb-post-image-bg">
				...
				<div class="nbdb-img-overlay"></div>
			</div>
<div class="nbdb-image-inner-content">
		<?php }
		...
		<?php if($postDate == "true" || $postAuthor == 'true' || $post_comments =="true") { ?>
			<div class="nbdb-post-date">
				<?php if($postAuthor == 'true') { ?>
					<span class="nbdb-user-img"><?php the_author(); ?></span>
				<?php } ?>
...
<?php } else {
	$nbdb_post_large_image = nbdb_get_post_featured_image( $post->ID );
?>
	<div class="nbdb-medium-4 nbdb-cell <?php if($grid_count <= 3) { echo 'flotRight'; } ?> <?php if($grid_count == 3) { echo 'clearboth'; } ?>" >
		<div class="nbdb-post-right-block nbdb-medium-12 nbdb-cell">
			<?php if(!empty($nbdb_post_large_image)) { ?>
				<div class="nbdb-medium-12 nbdb-cell">
					<div class="nbdb-post-image-bg">
						<a href="<?php echo esc_url( $post_link ); ?>">
							<img src="<?php echo esc_url( $nbdb_post_large_image ); ?>" alt="<?php the_title_attribute(); ?>" />
						</a>
						<div class="nbdb-img-overlay"></div>
						<div class="nbdb-image-inner-content">
						<div class="<?php if(!empty($nbdb_post_large_image)) { echo 'nbdb-medium-12 nbdb-cell'; } else { echo 'nbdb-medium-12 nbdb-cell'; } ?> ">
